...
our %config = (
    ...
    "openssldir" => "D:\\Sources\\openssl.3.1.2\\OpenSSL\\..\\Debug\\",
    "options" => "--debug --prefix=D:\\Sources\\openssl.3.1.2\\OpenSSL\\..\\Debug\\ --openssldir=D:\\Sources\\openssl.3.1.2\\OpenSSL\\..\\Debug\\ --libdir=..\\Debug no-acvp-tests no-afalgeng no-asan no-buildtest-c++ no-capieng no-crypto-mdebug no-crypto-mdebug-backtrace no-devcryptoeng no-dynamic-engine no-ec_nistp_64_gcc_128 no-egd no-external-tests no-fips no-fips-securitychecks no-fuzz-afl no-fuzz-libfuzzer no-ktls no-loadereng no-md2 no-msan no-rc5 no-sctp no-shared no-ssl3 no-ssl3-method no-trace no-ubsan no-unit-test no-uplink no-weak-ssl-ciphers no-zlib no-zlib-dynamic",
    "patch" => "2",
    ...
    "perlargv" => [
        "VC-WIN32",
        "--debug",
        "--prefix=D:\\Sources\\openssl.3.1.2\\OpenSSL\\..\\Debug\\",
        "--openssldir=D:\\Sources\\openssl.3.1.2\\OpenSSL\\..\\Debug\\",
        "--libdir=..\\Debug",
        "no-shared",
        "no-capieng"
...
our %unified_info = (
    ...
    "dirinfo" => {
        ...
        "test\\testutil" => {
            "deps" => [
                ...
                "test\\testutil\\libtestutil-lib-load.o",
                "test\\testutil\\libtestutil-lib-main.o",
                "test\\testutil\\libtestutil-lib-options.o",
                "test\\testutil\\libtestutil-lib-output.o",
                "test\\testutil\\libtestutil-lib-provider.o",
                "test\\testutil\\libtestutil-lib-random.o",
                "test\\testutil\\libtestutil-lib-stanza.o",
                "test\\testutil\\libtestutil-lib-test_cleanup.o",
    ...
    "sources" => {
        ...
        "test\\testutil\\libtestutil-lib-options.o" => [
            "test\\testutil\\options.c"
        ],
        "test\\testutil\\libtestutil-lib-output.o" => [
            "test\\testutil\\output.c"
        ],
        "test\\testutil\\libtestutil-lib-provider.o" => [
            "test\\testutil\\provider.c"
        ],
        "test\\testutil\\libtestutil-lib-random.o" => [
        ...
        "test\\threadstest" => [
            "test\\threadstest-bin-threadstest.o"
        ],
        "test\\threadstest-bin-threadstest.o" => [
            "test\\threadstest.c"
        ],
        "test\\threadstest_fips" => [
            "test\\threadstest_fips-bin-threadstest_fips.o"
        ],
        "test\\threadstest_fips-bin-threadstest_fips.o" => [
            "test\\threadstest_fips.c"
        ],
        "test\\time_offset_test" => [
            "test\\time_offset_test-bin-time_offset_test.o"
        ],
        "test\\time_offset_test-bin-time_offset_test.o" => [
...
unless (caller) {
    ...
    use lib 'D:/Sources/openssl.3.1.2/util/perl';
    use OpenSSL::fallback 'D:/Sources/openssl.3.1.2/external/perl/MODULES.txt';
    ...
    if (scalar @ARGV == 0) {
        ...
        use lib '.';
        use lib 'D:/Sources/openssl.3.1.2/Configurations';
        use gentemplate;
